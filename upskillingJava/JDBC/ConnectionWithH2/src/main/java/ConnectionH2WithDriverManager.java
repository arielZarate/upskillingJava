...
public class ConnectionH2WithDriverManager {

    public static void main(String[] args) {


        //le digo que se guarde en el escritorio de mi pc
        //  String url = "jdbc:h2:~/Escritorio/test";  //url conexion a bd H2
        String url = "jdbc:h2:mem:testdb";  //url conexion a bd H2 en MEMORIA


        String username = "sa"; //system administrator;
        String password = "";


        try {
            //create object Connection using DriverManager
