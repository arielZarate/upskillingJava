...
public class EjercicioClaseString {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("La cantidad de caracteres en la frase " + frase +" es: " + frase.length());
        ...
        System.out.println("Primera palabra de la frase: " + frase.substring(0, frase.indexOf("")));


        // Agrega 2 o más palabras en cualquier punto de la frase.
        System.out.println("Ingrese dos palabras para agregar a la frase:");
        String palabrasAgregar = scanner.nextLine();

        String nuevaFrase = frase.concat(" ").concat(palabrasAgregar);
